...
_add("off_sec_per_play", "Seconds/Play", "Average seconds between offensive snaps within a drive (lower = faster pace).", "seconds", False, "OFF", "wmean:off_plays", lo=10, hi=60, group="PACE")
_add("off_neutral_sec_per_play", "Neutral-Script Seconds/Play", "Seconds per play when the score is within 8 in the first three quarters (lower = faster pace).", "seconds", False, "OFF", "wmean:off_plays", lo=10, hi=60, group="PACE")
